...
cantones <-
  st_read(
    dsn = "C:/Users/Fiorela/Downloads/cantones.geojson",
    quiet = TRUE
  ) %>%
  st_transform(4326)
...
distritos <-
  st_read(
    dsn = "C:/Users/Fiorela/Downloads/distritos.geojson",
    quiet = TRUE
  ) %>%
  st_transform(4326) 
...
lista_tipo_delito <- c("Todas", lista_tipo_delito)
